...
#define ZF_ENV_ZFVERSION_MINOR()      3
...
PREDEFINED            += ZF_ENV_ZFCHAR_USE_CHAR_A
...
EXPAND_AS_DEFINED     += ZFPROPERTY_WEAK
EXPAND_AS_DEFINED     += ZFPROPERTY_WEAK_WITH_INIT
EXPAND_AS_DEFINED     += ZFPROPERTY_WEAK_READONLY
EXPAND_AS_DEFINED     += ZFPROPERTY_WEAK_DETAIL
...
EXPAND_AS_DEFINED     += ZFPROPERTY_PROGRESS_DECLARE
EXPAND_AS_DEFINED     += ZFPROPERTY_PROGRESS_DECLARE_BY_VALUE
