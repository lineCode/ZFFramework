...
protected:
    ...
    virtual void objectOnInit(void)
    {
        ...
        this->childRunning = zfAlloc(ZFArrayEditable);
        this->childToRun = zfAlloc(ZFArrayEditable);
    ...
    {
        zfRelease(this->childRunning);
        this->childRunning = zfnull;
        zfRelease(this->childToRun);
...
void ZFOperationQueue::taskOnStop(ZF_IN ZFOperationTaskData *operationTaskData)
{
    ...
    switch(queueResult->resultType())
    {
        ...
        case ZFResultType::e_Cancel:
        {
            ...
            zfblockedAlloc(ZFArrayEditable, childTaskDatasTmp);
